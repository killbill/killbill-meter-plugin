...
import org.killbill.billing.plugin.meter.timeline.persistent.CachingTimelineDao;
...
public class TimelineLoadGenerator {
    ...
    private static final int EVENT_CATEGORY_COUNT = Integer.parseInt(System.getProperty("org.killbill.billing.plugin.meter.timeline.eventCategoryCount", "250"));
    private static final int HOST_ID_COUNT = Integer.parseInt(System.getProperty("org.killbill.billing.plugin.meter.timeline.hostIdCount", "2000"));
    private static final int AVERAGE_SAMPLE_KINDS_PER_CATEGORY = Integer.parseInt(System.getProperty("org.killbill.billing.plugin.meter.timeline.averageSampleKindsPerCategory", "20"));
    private static final int AVERAGE_CATEGORIES_PER_HOST = Integer.parseInt(System.getProperty("org.killbill.billing.plugin.meter.timeline.averageSampleKindsPerCategory", "25"));
    private static final int SAMPLE_KIND_COUNT = EVENT_CATEGORY_COUNT * AVERAGE_SAMPLE_KINDS_PER_CATEGORY;
    private static final int CREATE_BATCH_SIZE = Integer.parseInt(System.getProperty("org.killbill.billing.plugin.meter.timeline.createBatchSize", "1000"));
    // Mandatory properties
    private static final String DBI_URL = System.getProperty("org.killbill.billing.plugin.meter.timeline.db.url");
    private static final String DBI_USER = System.getProperty("org.killbill.billing.plugin.meter.timeline.db.user");
    private static final String DBI_PASSWORD = System.getProperty("org.killbill.billing.plugin.meter.timeline.db.password");
